%{
This function is the fundamental feedforward Neural Network: 
...
As denoted by the file name, the activation function of the MLP is tanh(). 

To change the activation function, user can simply put the appropriate
function in place of tanh() in this source code.
